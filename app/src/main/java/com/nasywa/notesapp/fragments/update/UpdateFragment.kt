package com.nasywa.notesapp.fragments.update
...
import com.nasywa.notesapp.databinding.FragmentUpdateBinding
       ...
       val title = binding.etUptitle.text.toString()
        ...
        if (validation){
            val updateItem = NoteData(
                args.currentItem.id,title,mSharedViewModels.parsePriority(getPriority),
                description
            )
